  ...
  return (<div>
    <div className='Feed'>
      ...
      <div className='Feed__input'>
        <CreateIcon />
          <form> 
            <input value={input} onChange={(event) => setInput(event.target.value)} type='text' placeholder='Create a post'/>
      ...
      <div className='Feed__inputOption'>
        ...
        <InputOption Icon={CalendarViewDayIcon} title ='Write article'  color ='#cc2900' />
      </div>
  </div>
